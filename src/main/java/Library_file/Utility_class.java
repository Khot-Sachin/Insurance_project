...
public class Utility_class {
	...
	public static String getdeta(String key) throws IOException
	{
		...
		FileInputStream file=new FileInputStream("C:\\Users\\HP\\eclipse-workspace\\6August_maven\\properti.properties");
	...
	public static String getemail(int row,int cell) throws EncryptedDocumentException, IOException
	{
		// to fetch deta from the exel sheet
		 ...
		 FileInputStream file=new FileInputStream("C:\\Users\\HP\\eclipse-workspace\\6August_maven\\Test_data\\Book1.xlsx");
